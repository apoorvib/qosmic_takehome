...
- `WORKFLOWS.md` (≤1 page) — how you actually use coding agents day-to-day.  stack, delegation patterns, custom skills / slash commands / MCP servers you've built, what you let agents drive vs. always take the wheel on. Not about this take-home — about how you work.
...
**Submission:** either send over a zip containing your deliverables or create a GitHub repo, push your work, share the URL. Also include a Loom link with us by email (trustin@qosmic.ai). No fixed deadline — turn Toolit around within a few days of starting.
